      ...
      <div class="rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6">
        ...
        <div class="relative my-6">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2  text-gray-500 dark:text-slate-400">OR</span>
          </div>
        </div>
        ...
        <button type="button" @click="loginWithGoogle"
          ...
          <svg width="18" height="18" fill="currentColor" viewBox="0 0 18 18">
            <path
              ...
              fill="#4285F4" />
            <path
              d="M9 18c2.43 0 4.467-.806 5.96-2.184l-2.908-2.258c-.806.54-1.837.86-3.052.86-2.347 0-4.33-1.584-5.04-3.71H.957v2.332C2.438 15.983 5.482 18 9 18z"
              fill="#34A853" />
            <path
