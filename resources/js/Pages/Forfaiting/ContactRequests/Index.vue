      ...
      <div class="max-w-[1800px] mx-auto">
              ...
              <tbody>
                <tr v-for="request in filteredRequests" :key="request.id"
                  ...
                  <td class="text-center p-3">
                    <span :class="`px-2 py-1 rounded text-xs ${request.status === 'new'
                  ...
                  <td class="text-right p-3">
                    <select @change="(e) => updateStatus(request.id, (e.target as HTMLSelectElement).value)"
        ...
        <div v-if="contactRequests.links && contactRequests.links.length > 3" class="mt-6 flex justify-center">
          <div class="flex gap-2">
            <Link v-for="link in contactRequests.links" :key="link.label" :href="link.url || '#'" v-html="link.label"
