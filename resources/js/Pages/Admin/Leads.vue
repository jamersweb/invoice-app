    ...
    <template #header>
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          <input v-model="search" @keyup.enter="load" placeholder="Search..." class="rounded-lg border border-gray-300 px-3 py-2 text-sm" />
        ...
        <div v-else class="overflow-x-auto">
          <table class="min-w-full text-left text-sm">
            ...
            <tbody>
              ...
              <tr v-if="items.length===0"><td colspan="5" class="py-6 text-center text-gray-500">No leads</td></tr>
            </tbody>
          </table>
        </div>
      </div>
