        ...
        <div class="rounded-xl border border-gray-200  p-6">
          ...
          <div class="space-y-3">
            <div>
              ...
              <input v-model="form.customer_type" class="mt-1 w-full rounded-lg border border-gray-300 p-2"
                placeholder="e.g., LLC, Sole" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="number" v-model.number="form.expires_in_days"
