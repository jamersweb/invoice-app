...
<template>
  <div class="rounded-lg border border-gray-200 p-6">
    <div class="flex items-center justify-between">
      <div>
        <h4 class="text-sm font-medium text-gray-900">{{ documentType.name }}</h4>
      ...
      <div>
        <button
          ...
          class="cursor-pointer rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          Upload Files
        </button>
        <input
    ...
    <div class="mt-4">
      ...
      <input v-model="versionNote" @input="updateNote" class="mt-1 w-full rounded-lg border border-gray-300 p-2 text-sm" placeholder="e.g., Updated trade license 2025" />
    </div>
